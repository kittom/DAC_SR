...
def generate_leading_ones_ground_truth_with_noise(instance_sizes=None, noise_level=0.1, noise_type='gaussian', data_type='continuous'):
    """
    ...
    # Create Ground_Truth_Noise/LeadingOnes/{data_type} directory if it doesn't exist
