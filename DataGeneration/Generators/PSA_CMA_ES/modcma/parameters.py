...
class Parameters(AnnotatedStruct):
    ...
    pop_size_adaptation: (None,'constant','exp-inc', 'exp-dec', 'lin-inc', 'lin-dec', 'psa') = None
    ...
    def adapt_population_size(self) -> None:     
        ...
        #print(self.pop_size_adaptation)
        if self.pop_size_adaptation == 'exp-dec':
            ...
            self.correct_sigma()
        elif self.pop_size_adaptation == 'constant':
            new_lambda_ = self.lambda_
