...
# Import the single experiment setup
from experiment_setup import ExperimentRunner


class MasterExperimentRunner:
    def __init__(self, config_dir: str = "Experiments/Configs", global_todo_file: str = "global_TODO.txt"):
        ...
        self.experiment_record_dir = Path("Experiment_record")
    ...
    def setup_logging(self):
        ...
        self.experiment_record_dir.mkdir(exist_ok=True)
        
        logging.basicConfig(
            level=logging.INFO,
            format='%(asctime)s - %(name)s - %(levelname)s - %(message)s',
            handlers=[
                logging.FileHandler(self.experiment_record_dir / 'master_experiment_setup.log'),
    ...
    def find_config_files(self) -> List[Path]:
        """Find all JSON config files in the config directory and subdirectories."""
        config_files = []
...
def main():
    parser = argparse.ArgumentParser(description="Master Experiment Setup")
    parser.add_argument("--config-dir", default="Experiments/Configs", 
                       help="Directory containing config files (default: Experiments/Configs)")
