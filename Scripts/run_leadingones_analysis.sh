...
# Usage: ./run_leadingones_analysis.sh <path_to_results_csv>
...
echo "Running LeadingOnes analysis on $RESULTS_CSV..."
python3 Analysis/analyze_leadingones.py "$RESULTS_CSV"
