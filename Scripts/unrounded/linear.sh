...
# Linear Regression Activation and Execution Script (Unrounded)
...
cd "$SCRIPT_DIR/../../SR_algorithms/Linear"
...
python run_linear_on_csv.py "$CSV_FILE"
...
echo "Linear regression execution completed!" 